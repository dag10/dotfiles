...
dockutil --no-restart --add "/System/Applications/rekordbox 7/rekordbox.app"
dockutil --no-restart --add "/System/Applications/Utilities/Audio MIDI Setup.app"
#dockutil --no-restart --add "/System/Applications/Ableton Live 11 Suite.app"
dockutil --no-restart --add "/System/Applications/Ableton Live 12 Beta.app"
